...
<body class="min-h-screen relative">
    <header class="text-gray-600">
        <div class="container mx-auto flex justify-between items-center p-5 items-center">
            <a class="flex title-font font-medium items-center text-gray-900" href="{{ route('home') }}">
                ...
                <span class="ml-3 text-xl">LaraStore</span>
            </a>
            <div class="flex items-center">
                <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <a class="mr-5 hover:text-gray-900" href="{{ route('home') }}">Home</a>
                </nav>
                <a class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base md:mt-0"
                    href="{{ route('admin.products') }}">Admin
    ...
    <footer class="text-gray-600 absolute w-full bottom-0">
